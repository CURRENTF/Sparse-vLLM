...
ENGINE_KWARGS="${ENGINE_KWARGS:-{\"tensor_parallel_size\":1,\"gpu_memory_utilization\":0.88,\"max_model_len\":${SPARSEVLLM_CONTEXT_WINDOW},\"engine_prefill_chunk_size\":4096,\"sparse_method\":\"vanilla\"}}"
  ...
  cat >"${RUN_DIR}/run_manifest.json" <<JSON
{
  "run_name": "${RUN_NAME}",
  "repo_root": "${REPO_ROOT}",
  "claw_eval_dir": "${CLAW_EVAL_DIR}",
  "sparsevllm_conda_env": "${SPARSEVLLM_CONDA_ENV}",
  "claw_eval_conda_env": "${CLAW_EVAL_CONDA_ENV}",
  "model_path": "${MODEL_PATH}",
  "served_model_name": "${SERVED_MODEL_NAME}",
  "cuda_visible_devices": "${CUDA_VISIBLE_DEVICES}",
  "engine_kwargs": ${ENGINE_KWARGS},
  "server_base_url": "${SPARSEVLLM_OPENAI_BASE_URL}",
  "claw_eval_args": "${CLAW_EVAL_ARGS}",
