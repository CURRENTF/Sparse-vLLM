...
@pytest.mark.parametrize(
    ...
    [
        ...
        (_parallel_context(world_size=2, tp_size=2, tp_rank=1), "SVLLM_TP1"),
        (
        ...
        (_parallel_context(world_size=2, ep_size=2), "SVLLM_EP0"),
        (_parallel_context(world_size=2, dp_size=2), "SVLLM_DP0"),
    ],
)
