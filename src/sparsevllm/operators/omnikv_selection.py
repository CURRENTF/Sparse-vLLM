...
class FlashInferOmniKVSelection(OmniKVSelectionProvider):
    ...
    def supports(cls, spec, caps):
        ...
        from sparsevllm.kernels.external.flashinfer.topk import flashinfer_ragged_topk_support
    ...
    def _select(self, scores, lengths, k):
        from sparsevllm.kernels.external.flashinfer.topk import flashinfer_ragged_topk
...
class TritonOmniKVSelection(OmniKVSelectionProvider):
    ...
    def _select(self, scores, lengths, k):
        from sparsevllm.kernels.triton.omnikv_score import select_omnikv_history
