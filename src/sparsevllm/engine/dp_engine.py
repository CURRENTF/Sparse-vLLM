...
from sparsevllm.engine.chain_cache import ChainOwnerMismatchError, ChainRoutingSnapshot
from sparsevllm.engine.model_runner import select_master_port
...
class DPAttentionEngine:
    ...
    def _receive(self, ranks, *, fatal=False):
        ...
        deadline = time.monotonic() + float(
            os.getenv("SPARSEVLLM_DP_RPC_TIMEOUT_S", "1800")
        )
        while pending:
