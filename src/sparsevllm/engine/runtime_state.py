...
class RuntimeState:
    ...
    def step_resource_budgets(self, *, is_prefill: bool) -> dict[str, int]:
        return self.cache_manager.step_resource_budgets(is_prefill=is_prefill)

    def step_resource_costs(self, seq: Sequence, scheduled_tokens: int, *, is_prefill: bool) -> dict[str, int]:
        return self.cache_manager.step_resource_costs(seq, scheduled_tokens, is_prefill=is_prefill)
