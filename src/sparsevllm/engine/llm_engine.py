...
class LLMEngine:
    ...
    def _warmup(self):
        ...
        startup_capture = bool(
            getattr(self.config, "decode_cuda_graph_startup_capture", False)
        )
        ...
        if startup_plan:
            ...
            logger.info(
                ...
                len(startup_plan),
                self.config.decode_cuda_graph_max_cached_graphs,
                short_graphs,
                long_graphs,
                startup_plan,
            )
            ...
            captured = {
                ...
                and key.method == str(self.config.vllm_sparse_method or "")
    ...
    def worker_info(
        ...
        benchmark_config_keys = (
            ...
            "decode_cuda_graph_startup_capture_limit",
