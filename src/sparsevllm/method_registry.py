...
PREFILL_POLICY_LONG_BS1CHUNKED_DEFERRED_SHORT_BATCH = "long_bs1chunked_deferred_short_batch"
...
_DEFAULT_PREFILL_POLICY_BY_METHOD = {
    ...
    "deltakv": PREFILL_POLICY_LONG_BS1CHUNKED_DEFERRED_SHORT_BATCH,
}
...
PREFILL_POLICY_BY_METHOD = {
    **_DEFAULT_PREFILL_POLICY_BY_METHOD,
    ...
    "deltakv-less-memory": PREFILL_POLICY_LONG_BS1CHUNKED_DEFERRED_SHORT_BATCH,
    "deltakv_less_memory": PREFILL_POLICY_LONG_BS1CHUNKED_DEFERRED_SHORT_BATCH,
    "deltakv-less-memory-cudagraph": PREFILL_POLICY_LONG_BS1CHUNKED_DEFERRED_SHORT_BATCH,
    "deltakv_less_memory_cudagraph": PREFILL_POLICY_LONG_BS1CHUNKED_DEFERRED_SHORT_BATCH,
}
